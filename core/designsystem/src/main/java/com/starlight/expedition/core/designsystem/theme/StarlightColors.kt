...
val LightStarlightColors = StarlightColors(
    appBackground = Color(0xFFF7F7FC),
    windowBackground = Color(0xFFF7F7FC),
    surface = Color(0xFFFFFFFF),
    textPrimary = Color(0xFF151724),
    textMuted = Color(0xFF757988),
    line = Color(0xFFECEAF3),
